      ...
      <div className="space-y-6 animate-fade-in pb-20 md:pb-6">
        <div className="mb-2">
          ...
          <p className="text-muted-foreground mt-2">
            {role === 'admin' ? 'Manage meeting rooms and participants' : 'Book and manage meeting rooms'}
          </p>
        </div>
          ...
          <div>
            <Tabs defaultValue="management" className="w-full">
              <TabsList className="bg-secondary shadow-soft">
                <TabsTrigger value="management" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Manage Rooms</TabsTrigger>
                ...
                <TabsTrigger value="bookings" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">All Bookings</TabsTrigger>
              </TabsList>
