...
import AdminAttendanceManager from "@/components/attendance/AdminAttendanceManager";
      ...
      <div className="space-y-6 animate-fade-in pb-20 md:pb-6">
        <div className="mb-2">
          ...
          <p className="text-muted-foreground mt-2">
            {role === 'admin' ? 'Manage company-wide attendance records' : 'Track your work hours and attendance'}
          </p>
        </div>
